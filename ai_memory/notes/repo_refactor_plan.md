...
Opened 2026-08-30, pruned same day. Status (2026-08-31): **steps 1–3 done, step 4 (gate): both stacks LAUNCH AND TRAIN from the clean branches (1556228 GSM8K, 1557218 currease); numeric parity with the old lr3e6 arm FAILS at step 2 — upstream MarinSkyRL main takes a much larger effective step; control run 1557828 (old MarinSkyRL snapshot + new OTA/venv) isolates it; step 5 awaits Luke.** See "Status log" at the bottom. Companion: the OTA Code Atlas
