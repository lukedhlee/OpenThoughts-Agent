...
jupiter = HPC(
    ...
    # jpbo-122-[20,23,26-29] + jpbo-067-[06,08-12] added 2026-08-14 22:3x: backward-hang
    # sites of lr1e6 (1378384, mid-s13) and lr3e6 (1378002, s32 batch 10/32), scancel'd.
    # jpbo-030-[33,36,39,41,44,46] added 2026-08-14 23:0x: ghost-memory OOM at ckpt load
    # (lr3e6 1379098, 37MiB free at job start).
    ...
    # jpbo-107-[07-12] added 2026-08-15 02:3x: backward-hang site (nokl-v6 1379844 at s61).
    # jpbo-054-[01-03,09,12-13] added 2026-08-15 02:4x: backward-hang site (lr8e6-v9 1379329 at s55).
    ...
    # jpbo-008-[18,23,26-27,29,32] added 2026-08-15 03:5x: OOM at first ppo_train after clean load+gen
    # (lr8e6-v11 1380813, 607MiB free; first ref-offload run — dirty-node vs offload A/B pending on v14 arms).
    # jpbo-005-[34,37-38,43,46-47] added 2026-08-15 04:0x: ghost-OOM at ckpt load (lr1e6-v14 1380821, 14MiB free).
    # jpbo-078-[01-02,04,14-16] added 2026-08-15 04:3x: partial-ghost OOM at first ppo_train (lr1e6-v15 1380859, 146MiB free).
    # jpbo-079-[03,05,10-13] added 2026-08-15 04:5x: backward-hang site (lr8e6-v12 1380847 at s52).
    # jpbo-015-[17,19,21,23,29-30] added 2026-08-15 05:0x: ghost-OOM at ckpt load (lr1e6-v16 1380911, 8MiB free).
    # jpbo-016-[02,05,08-09,11,13] added 2026-08-15 05:1x: backward-hang site (nokl-v7 1380775 at s76, gs75 banked).
    # jpbo-060 escalated to RACK-LEVEL 2026-08-15 05:2x: second disjoint hit — [05-06,10,12,14,16] was an
    # early hang site; now [01-02,07,09,11,13] hung lr3e6-v14 1380822 at s51 (gs50 banked).
    # jpbo-083-[05-06,09,13,15-16] added 2026-08-15 05:3x: backward-hang site (lr8e6-v13 1380912 at s56, gs55 banked).
    # jpbo-093-[35-38,44,47] added 2026-08-15 05:5x: backward-hang site (lr1e6-v17 1380924 at s25).
    # jpbo-111-[09-12,15-16] added 2026-08-15 06:1x: ghost-OOM at ckpt load (lr1e6-v18 1381101, 36MiB free).
    # jpbo-079 escalated to RACK-LEVEL 2026-08-15 06:5x: second disjoint hit — [03,05,10-13] hang site
    # (inc 44); now [01,04,07-08,15-16] partial-ghost OOM'd lr1e6-v19 1381172 (713MiB free).
    # jpbo-022 escalated to RACK-LEVEL 2026-08-15 07:1x: second disjoint hit — [33,36-40] early sick site;
    # now [41-46] ghost-OOM'd lr1e6-v20 1381350 at load (87MiB free).
    # jpbo-019-[18-21,27,30] added 2026-08-15 07:2x: backward-hang site (lr8e6-v14 1381037 at s65, gs60 banked).
    # jpbo-053-[01-04,13-14] added 2026-08-15 07:4x: partial-ghost OOM at first ppo_train (lr1e6-v21 1381409, 572MiB free).
    # jpbo-029-[22-23,25,29,31-32] added 2026-08-15 08:0x: partial-ghost OOM at first ppo_train (lr8e6-v15 1381457, 88MiB free).
    # jpbo-029 ESCALATED rack-level 2026-08-15 11:2x CEST: 2nd disjoint hit — backward hang mid-s41 (lr1e6-v28 1382326, jpbo-029-[01,04-08]).
    # jpbo-064-[09-13,16] added 2026-08-15 15:4x CEST: backward hang mid-s58 (lr1e6-v29 1383332).
    # jpbo-026-[01,03-07] added 2026-08-15 18:1x CEST: EP-collective hang mid-s72 forward (lr1e6-v30 1384330).
    # jpbo-009-[21,23-25,27-28] added 2026-08-15 08:2x: backward-hang site (lr3e6-v15 1381010 at s64, gs60 banked).
    # jpbo-112 escalated to RACK-LEVEL 2026-08-15 08:4x: second disjoint hit — [05,08-12] hang site (inc 31);
    # now [25-30] partial-ghost OOM'd lr1e6-v22 1381465 (64MiB free).
    # jpbo-016 escalated to RACK-LEVEL 2026-08-15 09:0x: second disjoint hit — [02,05,08-09,11,13] nokl hang
    # site (inc 46); now [01,03-04,06-07,14] ghost-OOM'd lr1e6-v23 1381546 at load (27MiB free).
    # jpbo-001-[17-19,25,27,29] added 2026-08-15 09:2x: NCCL "unhandled cuda error" in EP all_to_all_single
    # during first forward (lr3e6-v16 1381529) — sick GPU, loud fail-fast variant of the EP failure.
    # jpbo-051-[17-22] added 2026-08-15 09:3x: ghost-OOM at ckpt load (lr1e6-v24 1381632, 67MiB free).
    # jpbo-067 escalated to RACK-LEVEL 2026-08-15 10:0x: second disjoint hit — [06,08-12] early hang site;
    # now [01-02,05,07,13-14] ghost-OOM'd lr1e6-v25 1381758 at load (25MiB free).
    # jpbo-120-[02,04-05,07-09] added 2026-08-15 10:2x: backward-hang site (lr8e6-v16 1381493 at s69, gs65 banked).
    # jpbo-018-[38-41,45-46] added 2026-08-15 10:4x: ghost-OOM at ckpt load (lr1e6-v26 1381815, 20MiB free).
    # jpbo-066 + jpbo-111 escalated to RACK-LEVEL 2026-08-15 11:1x: SIMULTANEOUS double hang (30s apart) —
    ...
    node_exclusion_list="jpbo-031-[01-48],jpbo-011-[01-48],jpbo-038-38,jpbo-004-46,jpbo-065-17,jpbo-074-22,jpbo-074-40,jpbo-048-41,jpbo-091-05,jpbo-044-0[1-5],jpbo-014-[01-48],jpbo-034-[18,23-25,27-29],jpbo-044-[07,11-15],jpbo-060-[01-48],jpbo-100-[01-48],jpbo-115-[42,44-48],jpbo-003-[35,37,39-40,42,45,47],jpbo-102-23,jpbo-103-20,jpbo-122-[02-03,20,23,26-29],jpbo-046-[27-32],jpbo-069-[01-02,05-08],jpbo-020-[01-48],jpbo-105-[42-46,48],jpbo-022-[01-48],jpbo-068-[09-13,16],jpbo-067-[01-48],jpbo-030-[33,36,39,41,44,46],jpbo-112-[01-48],jpbo-025-[17,22-23,29-30,32],jpbo-081-[10-15],jpbo-003-[20,23-24,26-27,30],jpbo-107-[07-12],jpbo-054-[01-03,09,12-13],jpbo-066-[01-48],jpbo-033-[33-36,45,48],jpbo-013-[17-18,20,23,25-26],jpbo-008-[18,23,26-27,29,32],jpbo-005-[34,37-38,43,46-47],jpbo-078-[01-02,04,14-16],jpbo-079-[01-48],jpbo-015-[17,19,21,23,29-30],jpbo-016-[01-48],jpbo-083-[05-06,09,13,15-16],jpbo-093-[01-48],jpbo-111-[01-48],jpbo-019-[18-21,27,30],jpbo-053-[01-04,13-14],jpbo-029-[01-48],jpbo-009-[21,23-25,27-28],jpbo-001-[17-19,25,27,29],jpbo-051-[17-22],jpbo-120-[02,04-05,07-09],jpbo-018-[38-41,45-46],jpbo-064-[09-13,16],jpbo-026-[01,03-07],jpbo-006-47,jpbo-018-[01-48],jpbo-019-[17,23-24,26,28-29],jpbo-122-[01,04,07,09,11,13],jpbo-081-[01-06],jpbo-030-[34-35,37-38,40,42],jpbo-010-[02-05,08-09],jpbo-039-[33-35,41-42,45],jpbo-059-[33-36,39,48],jpbo-034-[17,19-22,26],jpbo-003-[33-34,36,43-44,48],jpbo-026-[33-36,46,48],jpbo-030-[01-48],jpbo-059-[41,43-47],jpbo-095-[21-26],jpbo-076-[01-48],jpbo-107-[01-06],jpbo-026-[01-48],jpbo-040-[17-20,23-24],jpbo-074-[01-02,11-14],jpbo-051-[33-35,38,43-44],jpbo-081-[01-48],jpbo-037-[36,39,42-44,48],jpbo-017-[38-40,43-45]",
