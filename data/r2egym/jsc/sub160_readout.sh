...
until settled snowball_hist_placeholder_sub160 snowball_hist_head300_sub160; do sleep 60; done
...
python3 $C/hist_readout.py --probes keep=$K drop=$D last2=$L placeholder=snowball_hist_placeholder_sub160 head300=snowball_hist_head300_sub160 \
  --splits sub160=$E/hist_sub160.txt,idval=$E/tt_v2_idval.txt,oodval=$E/tt_v2_oodval.txt,heldout=$E/tt_v2_heldout.txt --out $O/hist_sub160_five >> $O/log 2>&1
